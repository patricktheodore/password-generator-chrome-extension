...
const Button: React.FC = () => {
  ...
  return (
    <button type='button' className='bg-primary hover:bg-secondary text-white shadow-lg font-bold py-2 px-4 mb-4 rounded inline-flex items-center text-center' onClick={() => { genPass() }}>
